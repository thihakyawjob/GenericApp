...
const cId_t GenericApp_ClusterCtrlList[GENERICAPP_MAX_CTRL_CLUSTERS] =
{
...
const SimpleDescriptionFormat_t GenericApp_SimpleCtrlDesc =
{
  GENERICAPP_CTRL_ENDPOINT,               //  int Endpoint;
  GENERICAPP_PROFID,                	  //  uint16 AppProfId[2];
  GENERICAPP_DEVICEID,             	  //  uint16 AppDeviceId[2];
  GENERICAPP_DEVICE_VERSION,       	  //  int   AppDevVer:4;
  GENERICAPP_FLAGS,                 	  //  int   AppFlags:4;
  ...
  0,                                      //  no input clusters
  (cId_t *) NULL,
  GENERICAPP_MAX_CTRL_CLUSTERS,           //  byte  AppNumOutClusters;
  (cId_t *)GenericApp_ClusterCtrlList,    //  byte *pAppOutClusterList;
#endif
#if defined(COORDINATOR)                  //  Coordinator
  GENERICAPP_MAX_CTRL_CLUSTERS,           //  byte  AppNumInClusters;
  (cId_t *)GenericApp_ClusterCtrlList,    //  byte *pAppInClusterList;
...
endPointDesc_t GenericApp_ctrlEpDesc;
#endif
...
void GenericApp_Init( uint8 task_id )
{
  ...
  SendMsgTimeout = SEND_MSG_TIMEOUT_DEFAULT;
  ...
  // populate and register the new control descriptors with the AF
#if !defined(COORDINATOR)
  GenericApp_ctrlEpDesc.endPoint = GENERICAPP_CTRL_ENDPOINT;
  GenericApp_ctrlEpDesc.task_id = & GenericApp_TaskID;
  GenericApp_ctrlEpDesc.simpleDesc
            = (SimpleDescriptionFormat_t *)& GenericApp_SimpleCtrlDesc;
  GenericApp_ctrlEpDesc.latencyReq = noLatencyReqs;

  afRegister( & GenericApp_ctrlEpDesc );
#endif
...
static void GenericApp_HandleKeys( uint8 shift, uint8 keys )
{
  ...
  ZDP_EndDeviceBindReq( &dstAddr, NLME_GetShortAddr(),
                            GenericApp_ctrlEpDesc.endPoint,
                            GENERICAPP_PROFID,
                            GENERICAPP_MAX_CTRL_CLUSTERS, (cId_t *)GenericApp_ClusterCtrlList,
                            GENERICAPP_MAX_CTRL_CLUSTERS, (cId_t *)GenericApp_ClusterCtrlList,
                            FALSE );
